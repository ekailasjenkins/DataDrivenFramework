...
public class TestConfig{
	...
	public static String from = "ekailasjenkins@gmail.com";
	public static String password = "eoxa kwik izqy cqwu";
	public static String[] to ={"ekailaskeshavpatil@gmail.com","ekailas@rediffmail.com"};
